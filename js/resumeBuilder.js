...
var education = {
  ...
  "display": function() {
    ...
    for (onlineCourse in education.onlineCourses) {
      var school = formatHtmlTemplate(HTMLonlineTitle,education.onlineCourses[onlineCourse].title);
      school = school + formatHtmlTemplate(HTMLonlineSchool,education.onlineCourses[onlineCourse].school);
